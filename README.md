...
Versions of MPPI and MPOPI implemented
 ...
 - MPOPI
   - [IMMPI](https://github.com/sisl/MPOPIS/blob/157f2d8dc94d71e39208eba8c8bc4f8061e31d83/src/mppi_mpopi_policies.jl#L317) (`:imppi`): iterative version of MPOPI similar to μ-AIS but without the decoupled inverse temperature parameter. μ-AIS is equivalent to IMPPI when λ_ais = λ.
